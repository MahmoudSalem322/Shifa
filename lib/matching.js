...
const STRENGTH = /(\d+(?:[.,]\d+)?)\s*(mg|ملغ|مغ|ملجم|g|غ|غرام|mcg|µg|ميكروغرام|ml|مل|iu|وحدة|%)/gi;
...
const UNIT_BASE = { 'ملغ': 'mg', 'مغ': 'mg', 'ملجم': 'mg', g: 'mg', 'غ': 'mg', 'غرام': 'mg', mcg: 'mg', 'µg': 'mg', 'ميكروغرام': 'mg', 'مل': 'ml', 'وحدة': 'iu' };
